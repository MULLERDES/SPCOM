<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageAdmin.master" AutoEventWireup="true" CodeBehind="AdminProductsCategoriesList.aspx.cs" Inherits="WCarDump.AdminProductsCategoriesList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdminContent" runat="server">
    <link href="css/StyleAdmin.css" rel="stylesheet" />
   
   <%-- <button runat="server" onserverclick="Button1_Click"> кнопка</button>--%>
    <div class="DWrapper">
        <div class="DHeader" >
            Здесь можно редактировать категории товаров. Для этого клацайте куда попало и все получится!
        </div>
        <div class="DHeader">
